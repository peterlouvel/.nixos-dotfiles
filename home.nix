...
in {
  ...
  #
  # You should not change this value, even if you update Home Manager. If you do want
  # to update the value, then make sure to first check the Home Manager release notes.
  ...
  # Home Manager manages dotfiles. The primary way to manage plain files is through 'home.file'.
  home.file = {
